...
var myApp1 = new Vue({
    ...
    data: {
        ...
        guide54: "قال الرسول صلى الله عليه وسلم: ((إن للقبر ضغطة لو كان أحد ناجياً منها نجا سعد بن معاذ)) رواه أحمد في مسنده",
...
function answer1 (){
if(document.getElementById("answerA1").value==boxone.threeA1||document.getElementById("answerA1").value=="الفارسي"||document.getElementById("answerA1").value=="سلمان الفارسي"){
